...
% vypocet souradnic koncoveho efektoru
for i = 1:length(Q1)
    for j = 1:length(Q3)
...
axis on
title('Singularni polohy pro $Q_2 = \pi$ bez ramen manipulatoru','interpreter','latex')
set(gcf,'color','w');
xlabel('Zobecnena souradnice $x$','interpreter','latex')
ylabel('Zobecnena souradnice $y$','interpreter','latex')
zlabel('Zobecnena souradnice $\varphi$','interpreter','latex')

%% Roztazeni do prostoru
